...
const ModalConfiguracionNota = ({ visible, tipo, columna, onClose, tiposColumna, escalas, tiposEvaluacion }) => {
      ...
      <div className="modal-form">
        ...
        <div className="modal-row">
          ...
          <select className="form-control" value={evaluacion} onChange={e => setEvaluacion(e.target.value)}>
            ...
            {tiposEvaluacion.map(op => <option key={op.id} value={op.Description}>{op.Description}</option>)}
          </select>
        ...
        <div className="modal-row">
          ...
          <select className="form-control" value={tipoColumna} onChange={e => setTipoColumna(e.target.value)}>
            <option value="">Seleccione</option>
            {tiposColumna.map(op => <option key={op.id} value={op.id}>{op.Description}</option>)}
          </select>
        </div>
        <div className="modal-row">
