   ...
   // Agregar log para tipoMatricula
    ...
    try {
        ...
        try {
            ...
            const personResult = await requestPerson.query(`
                INSERT INTO Person (FirstName, MiddleName, LastName, SecondLastName, RefSexId, Birthdate)
                OUTPUT INSERTED.PersonId
                VALUES (@FirstName, @MiddleName, @LastName, @SecondLastName, @RefSexId, @Birthdate)
            `);
	...
	// Condicional para actualizar LivesWithIndicator
      ...
      if (viveCon === 'Apoderado') {
        ...
        // Insertar el domicilio del Apoderado en PersonAddress
       ...
       // Si vive con Apoderado
 		...
 		`);
            ...
            if (tipoMatricula) {
                ...
                await requestTipoMatricula.query(`
                    ...
                    VALUES (@PersonId, @RefPersonStatusTypeId,1)
                `);
		...
		if (fechaRetiro && fechaRetiro !== '')
            ...
            // -----------------------------
           /* if (localEscolar) {
                console.log(`Insertando Local Escolar con ID: ${localEscolar} en PersonLocation...`);
